...
# No real network in specs; localhost stays open for the database and any
# in-process server a spec may start.
WebMock.disable_net_connect!(allow_localhost: true)
# Fail a spec that leaves time frozen or travelled.
